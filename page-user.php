        ...
        <div class="row">
          ...
          <div class="col-lg-3 g-mb-50 g-mb-0--lg">
            ...
            <div class="list-group list-group-border-0 g-mb-40">
              ...
              <!-- History -->
              <a href="#" class="list-group-item list-group-item-action justify-content-between" id="choiseHistory">
                <span><i class="icon-layers g-pos-rel g-top-1 g-mr-8"></i> Historique</span>
              </a>
              <!-- End History -->
...
<!-- PART HISTORY -->
          <div class="col-lg-9" id="hereChoiseHistory" style="display:none">
              <header class="text-center mb-4">
                <h3 class="h3 g-color-darkgrey g-font-weight-600">Historiques du compte</h3>
              </header>
             <!-- Timeline Box -->
                ...
                <div class="row">
                  ...
                  <div class="col-md-9 g-orientation-left g-pl-40--md">
                    ...
                    <article class="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                      ...
                      <img class="g-height-120 g-width-120 g-mb-25 g-mr-20" src="web/assets/img-temp/100x100/img411.jpg" alt="Image description">
                      <img class="g-height-120 g-width-120 g-mb-25 g-mr-20" src="web/assets/img-temp/100x100/img22.jpg" alt="Image description">
                      <img class="g-height-120 g-width-120 g-mb-25" src="web/assets/img-temp/100x100/img23.jpg" alt="Image description">
                    ...
                    <article class="g-pos-rel g-bg-gray-light-v5 g-pa-30">
                      ...
                      <div class="row g-mb-15">
                        <div class="col-md-5 g-mb-25 g-mb-0--md">
                          <img class="img-fluid w-100" src="web/assets/img-temp/400x270/img9.jpg" alt="Image description">
                        </div>
                        <div class="col-md-7">
                ...
                <div class="card border-0">
                  ...
                  <div class="js-scrollbar card-block u-info-v1-1 g-bg-white-gradient-v1--after g-height-300 g-pa-0">
                    ...
                    <div class="alert fade show g-bg-cyan-opacity-0_1 g-color-cyan rounded-0 g-mb-5" role="alert">
                      ...
                      <div class="media">
                        <div class="d-flex g-mr-10">
                          <img class="g-width-40 g-height-40 g-rounded-50x" src="web/assets/img-temp/100x100/img4.jpg"
                               alt="Image Description">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="alert fade show g-bg-orange-opacity-0_1 g-color-orange rounded-0 g-mb-5" role="alert">
                      ...
                      <div class="media">
                        <div class="d-flex g-mr-10">
                          <img class="g-width-40 g-height-40 g-rounded-50x" src="web/assets/img-temp/100x100/img4.jpg" alt="Image Description">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="alert fade show g-bg-red-opacity-0_1 g-color-lightred rounded-0 g-mb-5" role="alert">
                      ...
                      <div class="media">
                        <div class="d-flex g-mr-10">
                          <img class="g-width-40 g-height-40 g-rounded-50x" src="web/assets/img-temp/100x100/img2.jpg"
                               alt="Image Description">
                        </div>
                        <div class="media-body">
                  ...
                  <div class="js-scrollbar card-block  u-info-v1-1 g-bg-white-gradient-v1--after g-height-300 g-pa-0">
                    <ul class="list-unstyled">
                      <li class="d-flex justify-content-start g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-10">
                        <div class="g-mt-2">
                          <img class="g-width-50 g-height-50 rounded-circle" src="web/assets/img-temp/100x100/img2.jpg"
                               alt="Image Description">
                        </div>
                      ...
                      <li class="d-flex justify-content-start g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-10">
                        <div class="g-mt-2">
                          <img class="g-width-50 g-height-50 rounded-circle" src="web/assets/img-temp/100x100/img5.jpg"
                               alt="Image Description">
                        </div>
                        <div class="align-self-center g-px-10">
                          <h5 class="h6 g-font-weight-600 g-color-black g-mb-3">
                      ...
                      <li class="d-flex justify-content-start g-brd-around g-brd-gray-light-v4 g-pa-20 g-mb-10">
                        <div class="g-mt-2">
                          <img class="g-width-50 g-height-50 rounded-circle" src="web/assets/img-temp/100x100/img4.jpg"
                               alt="Image Description">
                        </div>
                        <div class="align-self-center g-px-10">
                          <h5 class="h6 g-font-weight-600 g-color-black g-mb-3">
