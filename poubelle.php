...
<html lang="en">
  ...
  <body>
                    ...
                    <div class="js-scrollbar g-height-200">
                        ...
                        <div class="row no-gutters g-pb-5">
                          <div class="col-4 pr-3">
                            <a class="u-basket__product-img" href="#!">
                              <img class="img-fluid" src="web/assets/img-temp/150x150/img1.jpg" alt="Image Description">
                            </a>
                          </div>
                      ...
                      <div class="u-basket__product g-brd-none g-px-20">
                        <div class="row no-gutters g-pb-5">
                          <div class="col-4 pr-3">
                            <a class="u-basket__product-img" href="#!">
                              <img class="img-fluid" src="web/assets/img-temp/150x150/img2.jpg" alt="Image Description">
                            </a>
                          </div>
                      ...
                      <div class="u-basket__product g-brd-none g-px-20">
                        <div class="row no-gutters g-pb-5">
                          <div class="col-4 pr-3">
                            <a class="u-basket__product-img" href="#!">
                              <img class="img-fluid" src="web/assets/img-temp/150x150/img3.jpg" alt="Image Description">
                            </a>
                          </div>
                      ...
                      <div class="u-basket__product g-brd-none g-px-20">
                        <div class="row no-gutters g-pb-5">
                          <div class="col-4 pr-3">
                            <a class="u-basket__product-img" href="#!">
                              <img class="img-fluid" src="web/assets/img-temp/150x150/img4.jpg" alt="Image Description">
                            </a>
                          </div>
              ...
              <div id="navBar" class="collapse navbar-collapse align-items-center flex-sm-row g-pt-15 g-pt-0--lg">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item g-ml-10--lg">
                    <a class="nav-link text-uppercase g-color-primary--hover g-pl-5 g-pr-0 g-py-20" href="web/index.html">Main</a>
                  </li>
                </ul>
              </div>
              <!-- End Navigation -->
    ...
    <script src="web/assets/vendor/jquery-ui/ui/widget.js"></script>
    ...
    <script src="web/assets/vendor/jquery-ui/ui/widgets/slider.js"></script>
    ...
    <script src="web/assets/js/components/hs.slider.js"></script>
